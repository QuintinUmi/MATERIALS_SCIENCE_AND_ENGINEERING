...
plt.annotate("Yield Point\nStrain = " + str(round(x_crsp, 4)) + "(%)\n" + "Stress = " + str(round(y_crsp, 4)) + "(MPa)", 
        xy=(x_crsp, y_crsp), xytext=(x_crsp + 1, y_crsp - 80), arrowprops=dict(facecolor='k', headwidth=5, width=1))
...
plt.annotate("Fracture Point\nStrain = " + str(round(x_fracture, 4)) + "(%)\n" + "Stress = " + str(round(y_fracture, 4)) + "(MPa)", 
        xy=(x_fracture, y_fracture), xytext=(x_fracture - 1, y_fracture - 80), arrowprops=dict(facecolor='k', headwidth=5, width=1))
